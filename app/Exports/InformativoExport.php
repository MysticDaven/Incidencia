...
class InformativoExport implements WithEvents
{
    use DelitosTrait;
    protected $rangos;
    protected $reporte;
    ...
    public function beforeWriting (BeforeWriting $event) {
        ...
        if (file_exists($templatePath)) {
            ...
            $period = 'INFORMATIVO ' . self::MONTH[$mesFinal - 1] . ' ' . 2001 . ' - ' . $year;
    ...
    public function realizarConsulta ($year, $mesInicial, $mesFinal, $value) {
        if ($value == 0 ){            
            ...
            ->where('AVE_MUNICIPIOS.MES', $mesFinal)
